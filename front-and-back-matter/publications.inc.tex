...
\newcommand{\pubtype}[1]{\xspace\color{gray}{(#1)}}
\renewcommand{\pubtype}[1]{ }

\section*{Journal articles\pubtype{C}}
\begin{enumerate}
...
\section*{Conference papers\pubtype{$\mathsf{I}_{\mathsf{2}}$}}
\begin{enumerate}
  \item \fullcite{Geerardyn2012IMTC}
  \item \fullcite{Larsson2012SYSID}
  \item \fullcite{Cooman2012SMACD} \TODO{remove (SMACD2012)}
  \item \fullcite{Geerardyn2014IFAC}
  \item \fullcite{Geerardyn2014ISMA}
  \item \fullcite{Voorhoeve2015} \TODO{update BIB entry}
\end{enumerate}

\section*{Abstracts, presentations, and posters\pubtype{$\mathsf{I}_{\mathsf{2}}$ and $\mathsf{J}_{\mathsf{2}}$}}
\begin{enumerate}
