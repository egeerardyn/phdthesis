...
\begin{enumerate}
\vspace{-0.5em}\item perform experiments to observe the system in a meaningful way,
\vspace{-0.5em}\item suppress unwanted effects and extract the features of interest from the measurements,
\vspace{-0.5em}\item fit a model to the measurements.
\end{enumerate}
...
In particular for low signal-to-noise ratios, local modeling or regularization provide considerable improvements. 
