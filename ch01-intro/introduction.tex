...
%TODO: peter: also discuss model selection for nonparametric here
...
Hence, the proposed techniques should be applicable for different areas of engineering: electrochemical, electronics, mechatronics, structural engineering, \latin{etc.}
...
In this dissertation, we assume the system behaves in a dominantly linear way.
...
This is especially important for complex systems: systems that have high-order dynamics, \gls{MIMO} systems with a high dimensionality, and networked systems amongst others.
