...
\subsubsection{How should a good experiment be designed?}
...
\subsubsection{Can we process the input/output data in a non-parametric way that offers more insight than a standard frequency response function?}
...
\subsubsection{Can we estimate the peak gain of a system in a non-parametric way?}
...
\subsubsection{Can we avoid local minima by using smoothers?}
