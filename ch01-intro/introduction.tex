...
System identification is the science---and often art---to deals with converting observations of a system into mathematical models to describe the behavior of the system under test.
