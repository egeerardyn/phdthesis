...
\begin{itemize}
  ...
  \item are the vibrations in a robot are small enough for it to perform very precise tasks such as positioning electronic components with sub-millimeter precision,
\end{itemize}
and so on.
