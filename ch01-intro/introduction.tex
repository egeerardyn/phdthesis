...
\begin{itemize}
  ...
  \item what the exhaust of nitrogen oxides of a car will be for a certain operating point of a diesel engine, 
  \item are the vibrations in a robot are small enough for it to carry out very precise tasks such as positioning electronic components with sub-millimeter precision,
\end{itemize}
and so on.
...
However, since most nonparametric estimators enforce very little prior knowledge about the system, noise in the measurements can sometimes be a problem to distinguish the actual system features.
