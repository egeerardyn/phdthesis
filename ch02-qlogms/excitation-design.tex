...
Such problem settings occur in many diverse fields of experimentation, such as the measurement of biochemical impedances\citep{Bragos2001,Sanchez2011}, electrochemical impedance spectroscopy~\citep{Niedostatkiewicz2009,VanGheem2004}, electronics\TODO{citation}, mechatronics\TODO{citation} and vibration testing\TODO{citation (ISMA?)}.
  ...
  \paragraph{Contents}
  In \secref{sec:excitation:inputDesign}, we first discuss (optimal) input design on an example second-order system.

  \TODO{
  \begin{itemize}
    \item input design
    \item system parametrization
    \item $1/f$ power
    \item frequency grid specification
    \item optimization of frequency grid
    \item simulations
    \item measurements
  \end{itemize}
  }

  \TODO{somewhere: mention D-optimal is indep of parametrization}
  \TODO{somewhere: mention optimality criterion is of lesser importance for a ``good'' signal (optimal in X = good in Y in most cases)}
