...
\subsection{Multisine Excitations}
  ...
  \begin{example}
   ...
   Then it is not possible to determine integer values $n_1$, $n_2$, $n_3$ such that $n_1 T_1 = n_2 T_2 = n_3 T_3$ since $T_3$ is an irrational number (unlike $T_1$ and $T_2$).
