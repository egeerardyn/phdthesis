...
Such problem settings occur in many diverse fields of experimentation, such as the measurement of biochemical impedances~\citep{Bragos2001,Sanchez2011}, electrochemical impedance spectroscopy~\citep{Niedostatkiewicz2009,VanGheem2004,Breugelmans2010}, electronics~\citep{Munir2011}, mechatronics, and vibration testing\TODO{citation (ISMA?)} amongst others.
...
\begin{assumption}
\TODO{assume separation in freq}
\end{assumption}
...
\begin{remark}
\TODO{leads to block-diagonal information matrix such that the variance of the FRF is decoupled near the resonances}
\end{remark}
