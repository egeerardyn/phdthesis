...
\section{Introduction} \label{sec:intro}
  It often occurs that we wish to measure the frequency response function (FRF) of a linear time invariant (LTI) system in a frequency band that covers several decades~\citep{Bragos2001,Sanchez2011,Niedostatkiewicz2009,VanGheem2004}.
