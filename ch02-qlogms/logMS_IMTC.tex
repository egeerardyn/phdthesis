...
\TODO{zin loopt niet goed}
  ...
  \begin{figure}
    ...
    \caption{Graphical depiction of the misalignment coefficient $\beta$ with respect to a logarithmic frequency grid with spacing $\alpha$ for two systems with different damping.}
  \end{figure}
