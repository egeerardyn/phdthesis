...
\TODO{rename labels}
\TODO{import specific bib items}
% \begin{abstract}
...
\section{Introduction} \label{sec:intro}
  It often occurs that we wish to measure the frequency response function (FRF) of a linear time invariant (LTI) system in a frequency band that covers several decades \citep{bragos2001characterisation,sanchez2011optimal,niedostatkiewicz2009,VanGheem2004}.
  ...
  This problem was already discussed in \citet{GeerardynIMTC2012}.
