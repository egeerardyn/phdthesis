...
\end{enumerate}
The axes are indicated in \figref{fig:avis:withAxes}.

\begin{figure}
  \centering
  \includegraphics{\thisDir/figs/avis-with-axes.pdf}
  \caption{\glsentrytext{AVIS} with $(x,y,z)$ coordinate frame indicated and bird's eye view of the approximate locations of the actuators and sensors. For each of the actuators and sensors, the color indicates the principal direction}
...
\begin{align}
  ...
  K_{\mathrm{sens}} & \approx \input{\thisDir/data/avis-setup/sensor-gains.tab.tex}
\end{align}
