...
\setlength\figurewidth{\columnwidth}
  ...
  \caption[\Simulink model used on the \glsentryshort{AVIS}]{\Simulink model used during the AVIS measurements. All signals are six-dimensional real values.}
...
\caption[\glsentryshort{AVIS} controller and filters]{Bode plots of the elements of $\experimental\Controller$ and sensor filter $F$ present in the set-up.}
...
\setlength\figurewidth{\columnwidth}
  ...
  \caption{\Simulink model of the \glsentryshort{AVIS} sub-block.}
