  \begin{itemize}
    ...
    \item \TODO{refer to book chapter of Tom}
  \end{itemize}
...
\end{align}
Using the $k_L(\omega)$ and $k_R(\omega)$ functions, two candidate values for $\svdMax{\Delta(\omega)}$ are obtained: $\svdMax{\LocalModel{\Delta}_{k_L(\omega)}(\omega)}$ and $\svdMax{\LocalModel{\Delta}_{k_R(\omega)}(\omega)}$.
...
\begin{figure}
  ...
  %TODO: add figure of isolation module as well
