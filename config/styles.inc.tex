...
\pgfplotsset{individualSamples/.append style={mark size=0.75pt,opacity=0.7,draw=none,solid,only marks}}
\pgfplotsset{boxplotBox/.append style={area legend,solid,draw=none,opacity=0.7}}
\pgfplotsset{boxplotBoxInit/.append style={area legend,solid,draw=none,opacity=0.15}}
\pgfplotsset{boxplotQuantiles/.append style={solid,line width=0.75pt}}
...
%% MC LRM
\pgfplotsset{mcline/.append style={line width=0.75pt}}
\pgfplotsset{mcrmse/.append style={mcline, dotted}}
\pgfplotsset{mcbias/.append style={mcline, solid}}
\pgfplotsset{mcvar/.append style={mcline, dashed}}
\pgfplotsset{mcnoise/.append style={mcline, solid}}
\pgfplotsset{mcpress/.append style={mcline, solid}}
...
\pgfplotsset{goodestimate/.style={color=TangoChameleon2,line join=round,line width=0.75pt}}
\pgfplotsset{badestimate/.style={color=TangoScarletRed2,solid,line join=round,line width=0.75pt}}
...
\pgfplotsset{finalmodel/.append style={line width=0.75pt}}
\pgfplotsset{initmodel/.append style={line width=0.75pt}}

\pgfplotsset{GVXI/.style={color=GVXI,line width=1pt}}
\pgfplotsset{G0Hat/.style={color=G0Hat,line width=1.5pt}}
\pgfplotsset{existing/.style={finalmodel,color=existing}}
\pgfplotsset{LPMTruncInit/.style={initmodel,color=LPMTruncInit,densely dashed}}
\pgfplotsset{LPMTrunc/.style={finalmodel,color=LPMTrunc}}
\pgfplotsset{RFIRInit/.style={initmodel,color=RFIRInit,densely dashed}}
\pgfplotsset{RFIR/.style={finalmodel,color=RFIR}}
\pgfplotsset{best/.style={finalmodel,color=best}}
