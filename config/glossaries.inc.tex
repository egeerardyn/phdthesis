...
\newsymbolglos{operator-log}{\log_{B} \placeholder}{Logarithm in base $B$ of \placeholder{}  (when B is omitted, the decimal logarithm is implied)}
\newsymbolglos{operator-matrix-ht}{\placeholder^{\HT}}{Hermitian transpose of the matrix \placeholder}
