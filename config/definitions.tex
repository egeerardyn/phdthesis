...
\newcommand{\chapterBasedOn}[1]{\vspace{-1\baselineskip}\researchBasedOn{#1}}
\newcommand{\sectionBasedOn}[1]{\vspace{-1\baselineskip}\researchBasedOn[This section]{#1}}
...
\newcommand{\Bignorm}[2][2]{\ensuremath{\Bigl\| #2 \Bigr\|_{#1}}}
...
\DeclareMathOperator{\ZT}{\mathcal{Z}}
\newcommand{\ZTransform}[1]{\ensuremath{\ZT \left\{ #1 \right\}}}
...
\newcommand{\RFIR}{\ensuremath{\mathrm{RFIR}}}
...
\newcommand{\VXI}{\ensuremath{\mathrm{VXI}}}
...
\newcommand{\modalOverlap}{\ensuremath{\mu}}
\newcommand{\modalDensity}[1]{\ensuremath{n_{\mathrm{m}}\left(#1\right)}}
...
\newcommand{\true}[1]{\ensuremath{\ifstrempty{#1}{\trueSymbol}{{#1}_{\trueSymbol}}}}
...
\newcommand{\LocalModel}[2][]{\ensuremath{\mathbold{\widetilde{#2}}\optionalSubscript{#1}}}
\newcommand{\leftAdjacent}{\ensuremath{k_{\mathrm{L}}}}
\newcommand{\rightAdjacent}{\ensuremath{k_{\mathrm{R}}}}

\newcommand{\LocalVector}[2][]{\ensuremath{\mathbold{#2}\optionalSubscript{#1}}}
