...
\renewcommand{\T}{\TT}   % \T is defined somewhere else: http://tex.stackexchange.com/questions/240691/disable-some-xunicode-macros-in-case-of-t1-font-encoding overwriting seems to work, but depends on the font used by XeTeX!
