...
\newcommand{\deemph}[1]{{\color{lightgray}{#1}}}
...
\newcommand{\NegativeRealNumbers}{\ensuremath{\RealNumbers^{-}}}
\newcommand{\RealNumbersWithoutZero}    {\ensuremath{\RealNumbers_{0}}}
...
\newcommand{\true}[1]{\ensuremath{{#1}_{\circ}}}
