...
\hat g_{\mathrm{RFIR}} &= \argmin_{g} \norm{y - g \conv u }^2 + \sigma^2 g^{\TT}P^{-1}g
\end{align}
...
\begin{figure}
  ...
  The empirical transfer function estimates $Y^{[r]}(\omega)/U^{[r]}(\omega)$~\legref{leg:bk1613:ETFE} and its average $\tilde{Y}(\omega)/\tilde{U}(\omega)$~\legref{leg:bk1613:meanETFE} obtained from the Elvis measurements are shown together with the estimated reference model $G_{\VXI}$~\legref{leg:bk1613:vxi}.} 
  \label{fig:bk1613}
\end{figure}
...
\begin{figure}[p]
  ...
  $\norm{G_{\VXI}}$\legref{leg:validationMeasurements:H2Norm} is shown as a reference.
  The bottom plot shows a linear zoom of the top plot.
