...
\pgfplotstableset{%
	...
	columns/P100/.style={column type=r,column name={\shortstack[r]{\textsc{Max.}\\{$100\%$}}}},
                  columns/Q/.style={column type=r,column name={\shortstack[r]{\textsc{$Q$.}\\{$\unit{dB}$}}}},
                  columns/NBW/.style={column type=r,column name={\shortstack[r]{\textsc{$N_{\mathrm{3dB}}$.}\\{}}}},
                  columns/tsmooth/.style={column type=r,column name={X}},
                  columns/tinit/.style={column type=r,column name={\shortstack[r]{\textsc{$t_{\mathrm{init}}$.}\\{$\unit{s}$}}}},
                  columns/tfinal/.style={column type=r,column name={\shortstack[r]{\textsc{$t_{\mathrm{final}}$.}\\{$\unit{s}$}}}},
