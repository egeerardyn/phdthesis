...
\end{equation}
where $\BW$ is the $3 \unit{dB}$ bandwidth of the system, is fixed to $\set{10, 20, 40, 60, \infty} \unit{dB}$.
...
To interpret the data, we aggregate the observed values over the frequencies to obtain:
\begin{align}
...
\begin{figure}[p]
  ...
  \label{fig:nparam:comparison:SNR}
\end{figure}
