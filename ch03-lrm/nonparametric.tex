...
\begin{bmatrix}
  ...
  \end{bmatrix}
  \evaluate{\left(  \PartialDerivative[2]{\ELSCost{\theta}}{ \theta^2 } \right)^{-1}}{A}
...
\begin{bmatrix}
  ...
  \end{bmatrix}
\end{align}
where $\evaluate{\left(  \PartialDerivative[2]{\ELSCost{\theta}}{ \theta^2 } \right)^{-1}}{A}$ denotes the upper left $\order{A}\times\order{A}$ subblock of $\left(  \PartialDerivative[2]{\ELSCost{\theta}}{ \theta^2 } \right)^{-1}$ which pertains to the parameters of $\LocalModel{A}$.
...
%TODO: tom: "inherently biased": verrgaande uitspraak in relatie met Levy: is normaal ook biased, maar voor ARX niet. Hoe zit dat hier?
