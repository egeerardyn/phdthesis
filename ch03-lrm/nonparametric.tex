...
\begin{figure}
  ...
  \caption[Output spectrum for local modeling, together the PRESS statistic]{It is convenient to compare the \glsentryshort{PRESS} (left plots) and the noise variance (right plots). The theoretical noise level is shaded and the transfer function is shown in bold.}
...
\TODO{PRESS is eigenlijk niet bruikbaar bij lage SNR}
