...
\TODO{figures to TikZ}
\TODO{re-introduce $F$-test truncator and box-carr averager}
...
\begin{figure}[htb] %  figure placement: here, top, bottom, or page
   \centering
	\includegraphics{\thisDir/figs/HistogramExpFitting.pdf}
         \caption[RMS error of the FRF versus truncation time.]{Black full line (left hand side y-axis (ordinate)): total \gls{RMS} error as a function of the truncation time (the single black dot is the minimum of the \gls{RMS}). Gray histogram (right hand side y-axis (ordinate)): selected truncation times for 1000 noise realizations by the exponential fitting methods.}
