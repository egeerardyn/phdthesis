...
\TODO{remove duplicate labels (global)}
...
The rest of the paper is structured as follows. \secref{se:theoryLPMandWindowing} covers the theory on the LPM and windowing for an OE setup.
