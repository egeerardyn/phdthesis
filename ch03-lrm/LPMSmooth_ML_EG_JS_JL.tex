...
Unfortunately, the \gls{LPM} presented in \TODO{\secref{sec:nparam:trunc:theoryLPMandWindowing}} and in \citep{Schoukens2009LPM} does not estimate the \gls{FRF}  at the frequency $\omega_0$ (i.e. \gls{DC} value of the \gls{FRF}), hence the subscript ``$\setminus\mathrm{DC}$'' in equation \eqref{eq:impRespiDFT}. 
